        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                    ...
                    <span class="fw-bold"><i class="fa fa-calendar me-2" aria-hidden="true"></i>Joined
                      {{ $created_at }}</span>
                        ...
                        <div class="col-6 text-center card-featured-nft" style="border-radius: 10px;">
                            <img id="sellerPhoto" src="{{ asset($image) }}"
                                 style="height: 25rem; box-shadow: 16px 16px #025959;"
                ...
                <div class="col-12 mt-5 px-5">
                    ...
                    <ul class="nav nav-pills nav-fill d-flex flex-wrap justify-content-between mt-2" id="myTab"
                        role="tablist"
                        ...
                        <li class="nav-item mb-3" role="presentation">
                            <a class="nav-link btn-lg btn-nav-pill px-4" id="created_tab" data-bs-toggle="tab"
                ...
                <div class="col-12 px-5 pt-3 mb-4">
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade show created" id="created" role="tabpanel"
                            ...
                            <div class="tab-pane fade show favorited" id="favorited" role="tabpanel"
                                 aria-labelledby="favorited_tab">
                                <div class="d-flex align-items-center justify-content-start">
                                    <div class="card explore-card shadow">
                                        <img src="./images/nft-explore-2.jpg" style="height: 15rem" class="card-img-top"
                                             alt="..."/>
                                        <div class="card-body text-center pb-0">
